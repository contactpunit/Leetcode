...
# and answer = [-1, -1] otherwise. If there are multiple choices for the two indices, return any of them.
...
# Output: [-1,-1]
# Explanation: In this example, it can be shown that it is impossible to find two 
